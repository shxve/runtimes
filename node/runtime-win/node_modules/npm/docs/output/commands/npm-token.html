...
You can request this as JSON with <code>--json</code> or tab-separated values with <code>--parseable</code>.</li>
</ul>
...
It can be <code>--read-only</code>, or accept a list of <a href="https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing">CIDR</a> ranges with which to limit use of this token.
This will prompt you for your password, and, if you have two-factor authentication enabled, an otp.</p>
<p>Currently, the cli cannot generate automation tokens.
Please refer to the <a href="https://docs.npmjs.com/creating-and-viewing-access-tokens">docs website</a> for more information on generating automation tokens.</p>
</li>
</ul>
...
This can accept both complete tokens (such as those you get back from <code>npm token create</code>, and those found in your <code>.npmrc</code>), and ids as seen in the parseable or json output of <code>npm token list</code>.
This will NOT accept the truncated token found in the normal <code>npm token list</code> output.</li>
</ul>
