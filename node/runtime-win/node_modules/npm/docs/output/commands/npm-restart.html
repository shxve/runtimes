...
<p>This restarts a project.
It is equivalent to running <code>npm run restart</code>.</p>
<p>If the current project has a <code>"restart"</code> script specified in <code>package.json</code>, then the following scripts will be run:</p>
<ol>
<li>prerestart</li>
<li>restart</li>
<li>postrestart</li>
</ol>
<p>If it does <em>not</em> have a <code>"restart"</code> script specified, but it does have <code>stop</code> and/or <code>start</code> scripts, then the following scripts will be run:</p>
<ol>
<li>prerestart</li>
<li>prestop</li>
<li>stop</li>
