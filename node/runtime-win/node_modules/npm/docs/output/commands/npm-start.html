...
<p>This runs a predefined command specified in the <code>"start"</code> property of a package's <code>"scripts"</code> object.</p>
<p>If the <code>"scripts"</code> object does not define a  <code>"start"</code> property, npm will run <code>node server.js</code>.</p>
<p>Note that this is different from the default node behavior of running the file specified in a package's <code>"main"</code> attribute when evoking with <code>node .</code></p>
<p>As of <a href="https://blog.npmjs.org/post/98131109725/npm-2-0-0"><code>npm@2.0.0</code></a>, you can use custom arguments when executing scripts.
Refer to <a href="../commands/npm-run.html"><code>npm run</code></a> for more details.</p>
